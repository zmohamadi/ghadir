...
export const NotCheckComments = ({ notCheckComments,mediaPath,Lang }) => {
                            ...
                            <div className="intro-y">
                                <div className="inbox__item inline-block sm:block text-gray-700 dark:text-gray-500 bg-gray-100 dark:bg-dark-1 border-b border-gray-200 dark:border-dark-1">
                                    <div className="flex px-5 py-3">
                                        ...
                                        <div className="inbox__item--time whitespace-nowrap mr-auto pr-10">{Tools?.toJalaliDateString(comment?.created_at)}</div>
                                    </div>
                                </div>
                            </div>        
                        );
