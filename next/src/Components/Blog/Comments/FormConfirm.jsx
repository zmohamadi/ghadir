...
import { useData,useFormRefs,Frame,Input,Button,ButtonContainer,Textarea,CheckBox } from "@/Theme/Midone/Forms";
...
export default function FormConfirm({id}){
                ...
                <Tab className="col-span-12">
                    ...
                    <TabBody>
                        <TabPanel id="tab-first" active={"true"}>
                            ...
                            <line />
                            {/* <SelectTail label="subject" refItem={[component, "subject_id"]} data={needles?.blogsubject} titleKey={"title_"+local} required="true" />
                                <SelectTail label="keyword" multiple="true"
                            ...
                            {/* <Textarea className="col-span-12" label="summary" refItem={[component, "summary"]} required="true" /> */}
