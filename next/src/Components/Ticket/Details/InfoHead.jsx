...
export const InfoHead = ({item,mediaPath,Lang}) => {
    ...
    return(
        <>
            ...
            {/* <div className="intro-y text-gray-700 dark:text-gray-600 mt-3 text-xs sm:text-sm">{item?.created_at} */}
            ...
            <div className="intro-y mt-6">
                <div className="news__preview image-fit">
                    <Pic src={mediaPath + "/tickets/" + item?.thumb} defaultImg={`${mediaPath}/public/default/ticket.png`} classImg="rounded-md" key={"img" + item?.thumb}  />
                </div>
            </div>
            <div className="intro-y flex relative pt-16 sm:pt-6 items-center pb-6">
                <div className="absolute sm:relative -mt-12 sm:mt-0 w-full flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm">
                    ...
                    {/* <div className="intro-x mr-1 sm:mr-3">{Lang("public.comments")+" : "}<span className="font-medium">60k</span> </div> */}
